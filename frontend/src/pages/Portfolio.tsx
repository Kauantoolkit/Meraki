...
import { Star, Briefcase, Award, User, GitBranch, ExternalLink, ChevronRight } from 'lucide-react'
...
export default function Portfolio() {
  ...
  return (
    <div className="bg-dark-bg bg-grid min-h-screen text-zinc-300 antialiased">
      ...
      <Navbar projectTitle="WORKSPACE // PORTFOLIO" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1 flex flex-col gap-4">
              <div className="bg-dark-card border border-dark-border p-6 relative">
                ...
                <button className="w-full btn-sharp bg-brand-500 text-dark-bg hover:bg-brand-400 font-mono font-bold text-xs py-3 border border-brand-500 transition-colors uppercase tracking-widest flex items-center justify-center gap-2 shadow-[4px_4px_0px_rgba(85,202,124,0.2)]">
                  <ChevronRight className="w-4 h-4" /> Editar Perfil
                </button>
              </div>
            ...
            <div className="lg:col-span-2">
              <div className="flex mb-6 border-b border-dark-border">
                ...
                <button
                  ...
                  className={`px-6 py-3 font-mono text-xs font-bold uppercase tracking-wider transition-colors border-b-2 -mb-px ${
                    tab === 'repos' ? 'text-brand-500 border-brand-500' : 'text-zinc-500 border-transparent hover:text-zinc-300'
                  }`}
                >
                  ...
                  {!profile.workHistory || profile.workHistory.length === 0 ? (
                    ...
                    <div key={i} className="bg-dark-card border border-dark-border p-5 hover:border-brand-500/30 transition-colors">
                      ...
                      <div className="flex items-center gap-1">
                        {[1,2,3,4,5].map(n => (
                          <Star key={n} className="w-3 h-3 text-orange-400 fill-orange-400" />
                        ))}
                ...
                <div className="space-y-3">
                  <div className="bg-dark-card border border-dark-border p-5 flex items-center gap-4 hover:border-brand-500/40 transition-colors">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-mono text-[10px] text-zinc-500 mt-0.5">Microserviço de entrega — NestJS + PostgreSQL</p>
                    </div>
                  ...
                  <div className="py-6 text-center border border-dashed border-zinc-700 font-mono text-zinc-600 text-xs">
                    Repositórios públicos sincronizados via integração GitHub.
                  </div>
                </div>
              )}
            </div>
