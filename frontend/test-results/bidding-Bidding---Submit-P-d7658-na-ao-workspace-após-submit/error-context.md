...
- Name: bidding.spec.ts >> Bidding - Submit Proposta (RF05, T8b apoio) >> F56 - retorna ao workspace após submit
- Location: e2e\bidding.spec.ts:74:3
...
Locator: getByText('PROPOSTA SUBMETIDA')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('PROPOSTA SUBMETIDA')
          ...
          - generic [ref=e102]:
            ...
            - generic [ref=e106]:
              - generic [ref=e107]:
                ...
                - generic [ref=e114]: "7"
                - generic [ref=e115]: "8"
              - textbox "Apresente a sua proposta técnica..." [ref=e116]: Proposta para teste de retorno.
            - generic [ref=e117]: "}"
          - generic [ref=e118]:
            - generic [ref=e119]:
              - img [ref=e120]
              - generic [ref=e122]: A proposta ficará invisível para concorrentes.
            - button "EXECUTE_SUBMIT()" [active] [ref=e123] [cursor=pointer]:
              - img [ref=e124]
