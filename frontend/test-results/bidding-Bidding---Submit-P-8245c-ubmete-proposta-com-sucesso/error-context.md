...
- Name: bidding.spec.ts >> Bidding - Submit Proposta (RF05, T8b apoio) >> F52 - submete proposta com sucesso
- Location: e2e\bidding.spec.ts:29:3
...
Locator: getByText('Projeto E2E Bidding')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Projeto E2E Bidding')
