...
export const ProjectSchema = new EntitySchema<Project>({
  ...
  columns: {
    ...
    specialistSignedAt: { type: 'timestamp', nullable: true },
    specialistSignedIp: { type: String, nullable: true },
    specialistSignedUserAgent: { type: 'text', nullable: true },
    companySignedAt: { type: 'timestamp', nullable: true },
    companySignedIp: { type: String, nullable: true },
    companySignedUserAgent: { type: 'text', nullable: true },
